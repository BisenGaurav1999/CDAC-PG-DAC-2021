...
public class LibraryValidation {
	...
	public static BookLibrary validateAll(String title, double price, String publishDate, String authorName,
			int quantity, String bookCat) throws LibraryExcHandler {
